...
export const profile = {
  ...
  linkedinPulse: {
    ...
    engagement: [
      ...
      { type: 'reshared', theme: 'Team building', actor: 'Dr. Estefania Tapias · WSP', text: 'Our Smart & Digital team is growing, with AI, full-stack and design roles across Dubai and India.', when: '5mo' },
      ...
      { type: 'liked', theme: 'WSP leadership', actor: 'Kathleen McGrail · MD Advisory, WSP', text: 'On connected, complex, consequential client projects and success beyond technical excellence.', when: '1w' },
